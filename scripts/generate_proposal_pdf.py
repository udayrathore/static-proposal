...
scope = [
    ...
    ("Venue Owner Experience", "Venue booking will be treated as a dedicated module within the platform. Although venues form part of the wider vendor ecosystem, the nature of venue enquiries and negotiations makes them sufficiently different to warrant a dedicated experience.<br/><br/>The proposed venue module will support destination weddings as well as city weddings, corporate events and other events where venue selection may involve multiple functions, dates, accommodation requirements and commercial negotiations.<br/><br/>The venue discovery experience will allow customers to search and filter properties based on relevant event parameters, explore detailed property profiles, review availability, shortlist suitable venues and then initiate enquiries and proposal workflows.", [
    ...
    ("ConnectX Operations", "ConnectX will have a central operational layer connecting customers, vendors and venue owners. The proposed administration interface will allow ConnectX to:", [
        "Manage and oversee customers, vendors and venue owners.", "View event, sub-event, vendor and venue information.", "Monitor enquiries, proposals and negotiations.", "Participate in or mediate customer, vendor and venue interactions.", "Track event, venue, enquiry, proposal and negotiation progress.", "Manage relevant platform data and workflows.", "Intervene when a customer requires assistance.", "Coordinate venue enquiries, proposals and negotiations where required, including cases where ConnectX participates directly between the customer and venue.", "Support hybrid or offline workflows where ConnectX becomes directly involved in delivering or coordinating a service.",
...
def build():
    ...
    for para in [
        "The proposed platform will allow users to create and plan events, define individual sub-events, discover and evaluate venues and vendors through parameter-based search, check relevant availability, shortlist options, facilitate enquiries, proposals and negotiations, and track the progress of their event through a centralised interface.",
